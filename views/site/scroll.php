...
$this->title = 'Scrollable';
$this->params['breadcrumbs'][] ="Scrollable"
?>
<div class="site-about">
    ...
    <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_scroll">
        <thead>
            <tr>
                <th>Record ID</th>
                <th>Order ID</th>
    ...
    <div class="kt-portlet__body">
        <!--begin: Datatable -->
        <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_scroll2">
            <thead>
                <tr>
                    <th>Record ID</th>
                    <th>Order ID</th>
